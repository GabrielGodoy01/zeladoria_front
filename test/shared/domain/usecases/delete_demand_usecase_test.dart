...
import 'package:clean_flutter_template/shared/domain/usecases/delete_demand_usecase.dart';
...
void main() {
  late DeleteDemandUsecase usecase;
  ...
  group('[TEST] - DeleteDemandUsecase', () {
    test('should return an Demand', () async {
      usecase = DeleteDemandUsecase(repositorySuccess);
    ...
    test('should return an Failure', () async {
      usecase = DeleteDemandUsecase(repositoryFailed);
