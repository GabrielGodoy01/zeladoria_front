...
import 'package:clean_flutter_template/shared/domain/usecases/update_demand_usecase.dart';
...
class DemandRepositoryMockSuccess extends Mock implements IDemandRepository {
  @override
  Future<Either<Failure, Demand>> updateDemand(Demand demand) async {
    var demand = Demand(
      id: 'id',
...
void main() {
  late UpdateDemandUsecase usecase;
  ...
  group('[TEST] - UpdateDemandUsecase', () {
    test('should return an Demand', () async {
      ...
      usecase = UpdateDemandUsecase(repositorySuccess);
    ...
    test('should return an Failure', () async {
      ...
      usecase = UpdateDemandUsecase(repositoryFailed);
      final result = await usecase(demand);
