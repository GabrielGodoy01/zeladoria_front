...
import 'package:clean_flutter_template/shared/domain/usecases/create_demand_usecase.dart';
...
class DemandRepositoryMockSuccess extends Mock implements IDemandRepository {
  @override
  Future<Either<Failure, Demand>> createDemand(Demand demand) async {
    var demand = Demand(
      id: 'id',
...
void main() {
  late CreateDemandUsecase usecase;
  ...
  group('[TEST] - CreateDemandUsecase', () {
    test('should return an Demand', () async {
      ...
      usecase = CreateDemandUsecase(repositorySuccess);
      final result = await usecase(demand);
    ...
    test('should return an Failure', () async {
      ...
      usecase = CreateDemandUsecase(repositoryFailed);
      final result = await usecase(demand);
